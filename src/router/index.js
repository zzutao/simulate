    ...
    children: [
      {
        ...
        name: '认识物质',
        meta: { title: '认识物质', icon: 'el-icon-info', affix: true }
      }
    ]
  },
  {
    ...
    children: [
      {
        ...
        name: '二维平面热运动',
        meta: { title: '二维平面热运动', icon: 'el-icon-cherry', affix: true }
      }
    ]
  },
  {
    ...
    children: [
      {
        ...
        name: '日志分析',
        meta: { title: '日志分析', icon: 'el-icon-data-analysis', affix: true }
      }
    ]
  },
  {
    ...
    children: [
      {
        ...
        name: '轨迹分析',
        meta: { title: '轨迹分析', icon: 'el-icon-data-line', affix: true }
      }
    ]
  },
  {
    ...
    children: [
      {
        ...
        name: '生成模拟视频',
        meta: { title: '生成模拟视频', icon: 'el-icon-video-camera-solid', affix: true }
      }
    ]
  },
  {
    ...
    children: [
      {
        ...
        name: '归纳数据集',
        meta: { title: '归纳数据集', icon: 'el-icon-s-management', affix: true }
      }
    ]
  }
  // {
